    ...
    <footer className="bg-cream-warm">
      ...
      <div className="container-custom py-10">
        <div className="grid md:grid-cols-3 gap-10">
          {/* Company Info */}
          <div>
            <h3 className="font-display text-base font-bold text-foreground mb-4">Pure Land Tours & Travels Pvt. Ltd.</h3>
            <div className="space-y-3 text-sm text-muted-foreground">
              <p className="leading-relaxed">
                A reliable travel service provider in Nepal, offering the best deals on inbound and outbound tours, air tickets, hotel reservations, and comprehensive travel services.
              </p>
              <div className="flex items-start gap-2 pt-2">
                <MapPin className="w-4 h-4 mt-1 flex-shrink-0 text-primary" />
                <div>
                  <p className="font-medium text-foreground">Trinity Tower, Maharajgunj</p>
                  <p>Kathmandu, Nepal</p>
                  <a 
                    href="https://www.google.com/maps/place/Pure+Land+Tours+and+Travels/@27.7374167,85.3377777,17z/data=!3m1!4b1!4m6!3m5!1s0x39eb190078010057:0x712221afbf890915!8m2!3d27.7374167!4d85.3403526!16s%2Fg%2F11y848mkx2?entry=ttu&g_ep=EgoyMDI2MDIwMS4wIKXMDSoASAFQAw%3D%3D"
                    target="_blank"
          ...
          <div>
            ...
            <div className="space-y-2 mb-6">
              ...
              >
                ...
                info@purelandtours.com
              </a>
              <a
                href="https://wa.me/9779863593271"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-primary hover:underline"
              >
            ...
            <div className="flex items-center gap-3">
              {/* WhatsApp */}
              <a href="https://wa.me/9779863593271" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/purelandtours" className="w-8 h-8 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
